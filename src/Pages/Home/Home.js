    ...
    <div>
      <div>
        ...
        >
          ...
          <div class="p-5 md:p-0 space-y-5">
            <p class="text-white font-bold text-3xl md:text-5xl flex flex-col items-center">
              <span>
                Unlimited movies, TV <br />
              </span>
              <span> shows and more. </span>
            </p>
            <p class="text-white font-semibold text-xl md:text-3xl flex flex-col items-center">
              Watch anywhere. Cancel anytime.
            </p>
            <p class="text-white text-sm md:text-lg flex flex-col align-middle text-center items-center">
            ...
            <div class="flex flex-col md:flex-row flex-wrap md:flex-nowrap items-center justify-center">
              <input
                ...
                class="p-2 md:p-4 focus:outline-none focus:ring-1 focus:ring-blue-300 w-3/4"
              />
              <Link to="/watch">
                <button class="p-3 my-3 md:my-0 md:p-4 text-sm md:text-lg font-semibold bg-red-600 hover:bg-red-700 text-white">
                  Get Started{" "}
                </button>
              </Link>
            </div>
        ...
        <div class="h-screen flex flex-wrap md:flex-nowrap items-center justify-center bg-black p-5">
        ...
        <div class="min-h-screen bg-black space-y-10">
          <br />
          <p class="p-5 text-white text-center font-bold text-3xl md:text-5xl flex justify-center">
          ...
          <p class="text-xl md:text-2xl text-center text-white">
            Ready to watch? Enter your email to create or restart your
            membership.
          </p>
          <div class="flex flex-col md:flex-row flex-wrap md:flex-nowrap items-center justify-center">
